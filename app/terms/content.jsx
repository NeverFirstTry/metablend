...
function AttributionList() {
  return (
    <ul className="list-disc pl-5 space-y-0.5 text-zinc-400">
      ...
      <li><a href="https://www.weather.gov" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-400">NOAA</a> (NWS &amp; Aviation Weather METARs, US public domain) · <a href="https://brightsky.dev" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-400">Bright Sky / DWD</a> · <a href="https://opendata.smhi.se" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-400">SMHI</a> (CC BY 4.0)</li>
      <li><a href="https://ourairports.com" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-400">OurAirports</a> (public domain) — airport &amp; runway data on the Aviation pages</li>
...
const CONTENT = {
  en: {
    ...
    sections: [
      ...
      { title: 'Not for safety-critical use', body: <>Do not rely on MetaBlend for decisions where weather accuracy matters to safety — aviation, marine, severe-weather, medical, or similar. Always consult an official meteorological service. The Aviation pages (<Link href="/aviation" className="text-emerald-400 hover:underline">/aviation</Link>) are supplementary information only — never use them for flight planning or navigation; always obtain an official preflight briefing. We are not liable for any loss or damage arising from use of the app.</> },
  ...
  de: {
    ...
    sections: [
      ...
      { title: 'Nicht für sicherheitskritische Zwecke', body: <>Verlass dich nicht auf MetaBlend, wenn Wettergenauigkeit sicherheitsrelevant ist — Luftfahrt, Seefahrt, Unwetter, Medizin oder Ähnliches. Ziehe immer einen offiziellen Wetterdienst zurate. Die Aviation-Seiten (<Link href="/aviation" className="text-emerald-400 hover:underline">/aviation</Link>) sind reine Zusatzinformation — niemals für Flugplanung oder Navigation verwenden; hole immer ein offizielles Preflight-Briefing ein. Wir haften nicht für Verluste oder Schäden aus der Nutzung der App.</> },
  ...
  fr: {
    ...
    sections: [
      ...
      { title: 'Pas pour un usage critique pour la sécurité', body: <>Ne vous fiez pas à MetaBlend pour des décisions où la précision météo touche à la sécurité — aviation, navigation, phénomènes violents, médical ou similaire. Consultez toujours un service météorologique officiel. Les pages Aviation (<Link href="/aviation" className="text-emerald-400 hover:underline">/aviation</Link>) ne sont qu’une information complémentaire — ne les utilisez jamais pour la préparation des vols ni la navigation ; obtenez toujours un briefing prévol officiel. Nous déclinons toute responsabilité pour les pertes ou dommages liés à l’utilisation de l’application.</> },
  ...
  it: {
    ...
    sections: [
      ...
      { title: 'Non per usi critici per la sicurezza', body: <>Non affidarti a MetaBlend per decisioni in cui la precisione meteo riguarda la sicurezza — aviazione, navigazione, eventi severi, ambito medico o simili. Consulta sempre un servizio meteorologico ufficiale. Le pagine Aviation (<Link href="/aviation" className="text-emerald-400 hover:underline">/aviation</Link>) sono solo informazioni supplementari — non usarle mai per la pianificazione dei voli né per la navigazione; ottieni sempre un briefing pre-volo ufficiale. Non rispondiamo di perdite o danni derivanti dall’uso dell’app.</> },
